...
def generate_pdf(docname,width, height, margin, title, subtitle, matrix):
    # Konfig
    ...
    table.setStyle(TableStyle([
        ...
        ("BOX", (0, 0), (-1, -1), 2, linecolor),  # Rahmenlinien für äußere Tabelle
    ...
    table_y = height - 6 * margin - table_height
